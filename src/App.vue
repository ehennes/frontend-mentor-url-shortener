...
import SectionMain from './layout/SectionMain.vue';
import LinkRequestForm from './components/LinkRequestForm.vue';
...
<template>
  ...
  <main>
    ...
    <SectionMain id="shorten-link" class="gray-theme">
      <template #content>
        <LinkRequestForm />
      </template>
    </SectionMain>
    
    <SectionMain id="advanced-statistics" class="gray-theme"> 
      <template #title>
        Advanced Statistics
      </template>
      <template #subtitle>
...
<style scoped lang="scss">
  header {
    ...
    > a {
      // hopefully remove this once I set up vue router
      display: contents;
    }
  }
